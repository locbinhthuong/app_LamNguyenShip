...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 87;/g, 'CURRENT_PROJECT_VERSION = 88;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 83/g, 'versionCode 84');
