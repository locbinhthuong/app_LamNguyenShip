...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 86;/g, 'CURRENT_PROJECT_VERSION = 87;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 82/g, 'versionCode 83');
