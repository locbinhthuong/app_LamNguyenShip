...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 88;/g, 'CURRENT_PROJECT_VERSION = 89;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 84/g, 'versionCode 85');
