...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 89;/g, 'CURRENT_PROJECT_VERSION = 90;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 85/g, 'versionCode 86');
