...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 78;/g, 'CURRENT_PROJECT_VERSION = 79;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 74/g, 'versionCode 75');
