...
// Driver app
bump('c:/app_LamNguyenShip/driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = 83;/g, 'CURRENT_PROJECT_VERSION = 84;');
bump('c:/app_LamNguyenShip/driver-app/android/app/build.gradle', /versionCode 79/g, 'versionCode 80');
