...
const buildGradlePath = 'frontend/android/app/build.gradle';
...
const pbxprojPath = 'frontend/ios/App/App.xcodeproj/project.pbxproj';
...
console.log('Bumped frontend to ' + newVersion);
