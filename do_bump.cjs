...
// Driver App
bump('driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = \d+;/g, 'CURRENT_PROJECT_VERSION = 102;');
bump('driver-app/ios/App/App.xcodeproj/project.pbxproj', /MARKETING_VERSION = [\d\.]+;/g, 'MARKETING_VERSION = 1.8.13;');
bump('driver-app/android/app/build.gradle', /versionCode \d+/g, 'versionCode 102');
bump('driver-app/android/app/build.gradle', /versionName ".*"/g, 'versionName "1.8.13"');
bump('driver-app/package.json', /"version": ".*"/, '"version": "1.8.13"');
