...
// Driver App
bump('driver-app/ios/App/App.xcodeproj/project.pbxproj', /CURRENT_PROJECT_VERSION = \d+;/g, 'CURRENT_PROJECT_VERSION = 99;');
bump('driver-app/ios/App/App.xcodeproj/project.pbxproj', /MARKETING_VERSION = [\d\.]+;/g, 'MARKETING_VERSION = 1.8.12;');
bump('driver-app/android/app/build.gradle', /versionCode \d+/g, 'versionCode 100');
