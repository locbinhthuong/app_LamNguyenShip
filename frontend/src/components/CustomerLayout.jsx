...
import { Search, Clock, Bell, User, MapPin, LogOut, HelpCircle, LayoutDashboard, Search as SearchIcon, Phone } from 'lucide-react';
  ...
  return (
    <div className="flex w-full h-[100dvh] bg-[#f8fafc] font-sans overflow-hidden">
      ...
      <div className="hidden md:flex flex-col w-[260px] bg-white border-r border-gray-100/60 shadow-[4px_0_24px_rgba(0,0,0,0.01)] z-40 h-full relative">
        <div className="pt-8 pb-6 px-8 flex flex-col items-center justify-center border-b border-gray-50/50">
          ...
          <div className="flex justify-center items-center gap-2.5 mt-5">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-50/80 text-blue-600 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all shadow-sm" title="Facebook">
              <svg width="14" height="14" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-slate-100 text-slate-800 flex items-center justify-center hover:bg-slate-800 hover:text-white hover:-translate-y-1 transition-all shadow-sm" title="TikTok">
            ...
            <a href="https://zalo.me" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-blue-50/80 text-blue-500 flex items-center justify-center hover:bg-blue-500 hover:text-white hover:-translate-y-1 transition-all shadow-sm font-bold text-[9px]" title="Zalo">
              Zalo
            </a>
            <a href="tel:1900xxxx" className="w-8 h-8 rounded-full bg-red-50/80 text-red-500 flex items-center justify-center hover:bg-red-500 hover:text-white hover:-translate-y-1 transition-all shadow-sm" title="Hotline">
