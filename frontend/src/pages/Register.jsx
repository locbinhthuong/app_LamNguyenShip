...
const Register = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4 bg-orange-50 pt-10 pb-10">
        ...
        <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-2xl">
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${
              formData.role === 'CUSTOMER' ? 'bg-white text-orange-600 shadow-sm' : 'text-gray-500'
            }`}
          >
            Khách Cá Nhân
          </button>
          <button
            ...
            className={`flex-1 py-2.5 rounded-xl text-sm font-semibold transition-all ${
              formData.role === 'SHOP' ? 'bg-white text-orange-600 shadow-sm' : 'text-gray-500'
            }`}
          >
            Chủ Cửa Hàng
          </button>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          {formData.role === 'SHOP' && (
            <div className="p-4 bg-orange-50 rounded-2xl border border-orange-100 space-y-3">
              <h3 className="font-semibold text-orange-800 text-sm">Thông tin Cửa Hàng (Bắt buộc)</h3>
              <div>
                <input
                  type="text"
                  name="shopName"
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-2.5 rounded-xl border border-orange-200 focus:border-orange-500 outline-none text-sm"
